  ...
  Widget build(BuildContext context) {
    ...
    return SimpleDialog(
        ...
        Column(
          ...
          children: <Widget>[
            Text('Où?',textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'Raleway')),
            ...
            Text('Quand?',textAlign: TextAlign.left,style: TextStyle(fontWeight: FontWeight.w600,fontFamily: 'Raleway')),
            ...
            new Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: new DropdownButton<String>(
                      ...
                      hint:  _dayLeft == null
                                            ?
                                              Text(_dayLeft = "moins de 3 jours",
                                                style: TextStyle(
                                                    fontFamily: 'Raleway'
                                                ),
                                              )
                      ...
                      value: _dayLeft,
                      items: <String>["moins de 3 jours", "plus de 3 jours"]
                          .map((String value) {
                        return new DropdownMenuItem<String>(
                          value: value,
                          child: new Text(value,
