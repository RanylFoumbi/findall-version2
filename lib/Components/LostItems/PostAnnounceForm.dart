...
/*    final datePicker = new Container(
    ...
    final phoneTitle =  new Container(
        ...
        child: Row(
          children: <Widget>[
            Expanded(
              child: Text("Laissez votre numéro de téléphone afin que vous puissiez être contacté si quelqu'un trouve votre objet.",
                style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w400,
                    fontFamily:"Raleway"
    ...
    final rewardTitle =  new Container(
        width: width/1.15,
        padding: EdgeInsets.only(left: 6.5,right: 6.5),
        child: Row(
          children: <Widget>[
            Expanded(
              child: Text("Pourriez-vous récompenser quelqu'un qui trouve votre objet?",
                style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w400,
                    fontFamily:"Raleway"
    ...
    final reward =  new Container(
        ...
        child: DropdownButtonHideUnderline(
          child: new DropdownButton<String>(
              ...
              Text(_isRewarded = "OUI",textAlign: TextAlign.center,)
                  :
              Text(_isRewarded,
                style: TextStyle(
                    fontFamily:"Raleway"
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          SizedBox(width: 5),
                          Text('Publier une annonce',textAlign: TextAlign.start,style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700,fontFamily: 'Raleway')),
                        ],
                      ),
