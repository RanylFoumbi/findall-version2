...
class _PreviewAnnounceState extends State<PreviewAnnounce> {
  ...
  void _createLostObject(data)async{
    setState(() {
      _isLoading = true;
    });
    await db.collection("ObjectList").add({
      ...
      'images': data['images'],
      'userId': data['userId'],
      'ownerName': _user.providerData[0].displayName,
  ...
  void _publish(imagesUrl,userId) async{
    ...
    var dataToSave = {
      ...
      'rewardAmount': widget.rewardAmount == "OUI" ? "Possible" : "Aucune récompense",
      'images': imagesUrl,
      'userId': userId,
    };

    _createLostObject(dataToSave);
  }
                       ...
                       /*   SizedBox(height: 15 ),
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 5),
                              Text('Perdu le:', style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 13,fontFamily: 'Raleway')),
                              SizedBox(width: 5 ),
                              Expanded(
...
*/
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 5),
                              Text('Perdu à:', style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 13,fontFamily: 'Raleway')),
                              SizedBox(width: 5 ),
                              Expanded(
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 5),
                              Text('Récompense:', style: TextStyle(color: Colors.black.withOpacity(0.5),fontSize: 13,fontFamily: 'Raleway')),
                              SizedBox(width: 5 ),
                              Expanded(
                                  child: Text(widget.rewardAmount == "OUI" ? "Possible" : "Aucune récompense", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13,fontFamily: 'Raleway'))
                              )
                            ],
                          ),
