        ...
        builder: (BuildContext context){
          return SimpleDialog(
            ...
            title: Row(
              ...
              children: <Widget>[
                Expanded(
                  child: Text("Nous vous contacterons dès que possible. "+' ',style: TextStyle(fontWeight: FontWeight.w800,fontFamily: "Raleway"),
          ...
          body: ListView(
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Text(
                    ' Vous voulez que nous trouvions rapidement',
                    style: TextStyle(
                        color: Colors.black,
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: FloatingActionButton.extended(
                      label: Text('Retour',style: TextStyle(color: Colors.deepPurple,fontFamily: 'Raleway'),
                      ),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10)
                      ),
